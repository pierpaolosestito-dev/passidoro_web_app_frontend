...
$(document).on('click', '#confirm-btn', function(){
  ...
  console.log($('#nuova-email').val());
    ...
    nuovapassword = $('#nuova-password').val();
    passwordattuale = $('#vecchia-password').val()
    ...
    aggiornamento_profilo = {'email':sessionStorage.getItem('email'),'old_password':passwordattuale,'new_password1':nuovapassword,'new_password2':$('#nuova-password').val()}
