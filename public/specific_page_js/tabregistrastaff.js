  ...
  return;
    ...
    Swal.fire({
      ...
      didOpen: function(){
        ...
        membro_staff = {'Nome':$('#nome').val(),"Cognome":$('#cognome').val(),"Email":$('#email').val(),"Ruolo":$('input[name="permessi"]:checked').val()+""}
    axios({method:"post",url:'http://127.0.0.1:8000/staff',data:membro_staff,headers:{"Authorization":"Token " + sessionStorage.getItem("key")}})
            .then(response => {
